    ...
    <div id="modal_form_jamMasuk" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('hrdPeraturan.editJamMasuk', $id) }}" method="POST">
    ...
    <div id="modal_form_jamPulang" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php $id = Crypt::encrypt($peraturan->id); ?>
                <form action="{{ route('hrdPeraturan.editJamPulang', $id) }}" method="POST">
    ...
    <div id="modal_form_cutiTahunan" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php $id = Crypt::encrypt($peraturan->id); ?>
                <form action="{{ route('hrdPeraturan.editCutiTahunan', $id) }}" method="POST">
    ...
    <div id="modal_form_cutiBersama" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php $id = Crypt::encrypt($peraturan->id); ?>
                <form action="{{ route('hrdPeraturan.editCutiBersama', $id) }}" method="POST">
    ...
    <div id="modal_form_cutiPenting" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php $id = Crypt::encrypt($peraturan->id); ?>
                <form action="{{ route('hrdPeraturan.editCutiPenting', $id) }}" method="POST">
    ...
    <div id="modal_form_cutiSakit" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php $id = Crypt::encrypt($peraturan->id); ?>
                <form action="{{ route('hrdPeraturan.editCutiSakit', $id) }}" method="POST">
    ...
    <div id="modal_form_cutiBesar" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php $id = Crypt::encrypt($peraturan->id); ?>
                <form action="{{ route('hrdPeraturan.editCutiBesar', $id) }}" method="POST">
    ...
    <div id="modal_form_cutiHamil" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php $id = Crypt::encrypt($peraturan->id); ?>
                <form action="{{ route('hrdPeraturan.editCutiHamil', $id) }}" method="POST">
