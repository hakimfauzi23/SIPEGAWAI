    ...
    <div class="page-header page-header-default">
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{ route('hrdPegawai.showDivisi', $id_pegawai) }}"> Daftar Riwayat Jabatan
                    </a>
                </li>
...
@section('content')
    <!-- 2 columns form -->
    <form method="post" enctype="multipart/form-data" action="{{ route('hrdPegawai.updateRiwayatDivisi', $id) }}">
