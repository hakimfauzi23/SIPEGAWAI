...
@section('title', 'Edit Penilaian Pegawai')
...
@section('content')
    ...
    <form method="post" enctype="multipart/form-data" action="{{ route('penilaian.update', $id) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <input type="number" class="form-control" name="responsible"
                                                value="{{ $penilaian->responsible }}" placeholder="Skala 10-100">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="number" class="form-control" name="initiate"
                                                value="{{ $penilaian->initiate }}" placeholder="Skala 10-100">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="number" class="form-control" name="teamwork"
                                                value="{{ $penilaian->teamwork }}" placeholder="Skala 10-100">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="number" class="form-control" name="work_performance"
                                                value="{{ $penilaian->work_performance }}" placeholder="Skala 10-100">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control"
                                                value="{{ $penilaian->discipline }}  (Berdasarkan presensi serta jumlah terlambat/pulang awal)"
                                                placeholder="Skala 10-100" alt="Nilai ini" disabled>
                                            <input type="hidden" class="form-control" name="discipline"
                                                value="{{ $penilaian->discipline }}" placeholder="Skala 10-100">
                                        </div>
