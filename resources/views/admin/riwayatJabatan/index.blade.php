...
@section('content')
    <div class="panel bg-info">
        <div class="panel-heading">
            <em>
                <h6>Pada halaman merupakan daftar list pegawai yang bisa dipilih untuk dilihat riwayat jabatanya. klik saja
                    tombol "Lihat" maka daftar riwayat jabatan akan muncul.
                </h6>
            </em>
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <div class="text-right mb-4">
                <form action="{{ route('riwayatJabatan.search') }}" method="GET">
