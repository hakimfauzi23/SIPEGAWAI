...
@section('content_header')
    <div class="page-header page-header-default">
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                <li><i class="active icon-home2 position-left"></i> List Data Tunjangan</li>
...
@section('content')
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <a href="{{ route('tunjangan.create') }}"><i class="icon-file-plus"></i> Tambah Data Tunjangan </a>
        </div>
