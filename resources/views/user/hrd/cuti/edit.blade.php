...
@section('content')
    ...
    <section class="about-area section-gap">
        <div class="container">
            ...
            <nav aria-label="breadcrumb" class="main-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{{ route('hrdCuti.show', $id) }}">{{ $cuti->id . '-' . $cuti->pegawai->nama }} </a>
                    </li>
            ...
            <form method="post" action="{{ route('hrdCuti.update', $id) }}">
                ...
                <div class="form-group">
                    <a href="{{ route('hrdCuti.show', $id) }}" class="btn btn-primary">Kembali</a>
