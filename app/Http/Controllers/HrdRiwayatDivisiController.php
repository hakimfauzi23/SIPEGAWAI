...
class HrdRiwayatDivisiController extends Controller
{
    /**
    ...
    public function show($data)
    {
        ...
        return view('user.hrd.riwayatDivisi.detail', [
            'id' => $data,
            'pegawai' => $pegawai,
    ...
    public function edit($data)
    {
        ...
        return view('user.hrd.riwayatDivisi.edit', [
            'id' => $data,
            'riwayat_divisi' => $riwayat_divisi,
            'divisi' => $divisi,
            'currentPage' => $currentPage
    ...
    public function update(Request $request, $data)
    {
        ...
        return redirect(route('hrdRiwayatDivisi.show', $encrypt));
    }
