...
!(function (e) {
            ...
            (i.prototype = {
                    ...
                    ;(this._zr = i),
                        (this._messageCenter.dispatch = function (e, i, n, a) {
                            ;(n = n || {}),
                                ...
                                t._messageCenterOutSide.dispatchWithContext(
                                    e,
                                    n,
                                    a
                                )
                        ...
                        case a.EVENT.TOOLTIP_OUT_GRID:
                            if (t) {
                                if (this._connected) {
                                    ...
                                    o &&
                                        ((e.x =
                                            (e.event.zrenderX - o.getX()) /
                                            o.getWidth()),
                                        (e.y =
                                            (e.event.zrenderY - o.getY()) /
                                            o.getHeight()))
                                }
                            } else {
                                var o = this.component.grid
                ...
                _ondragend: function (e) {
                    if (
                        ...
                        this._timeline &&
                            this._timeline.ondragend(e, this._status),
                ...
                _noDataCheck: function (e) {
                    for (var t = e.series, i = 0, n = t.length; n > i; i++)
                        if (
                            ...
                            return !1
                    var o = (this._option &&
                        this._option.noDataLoadingOption) ||
                ...
                _render: function (t) {
                    if ((this._mergeGlobalConifg(t), !this._noDataCheck(t))) {
                        ...
                        for (
                            var u, V, U, g = {}, m = 0, p = t.series.length;
                            p > m;
                            m++
                        )
                            (V = t.series[m].type),
                ...
                refresh: function (e) {
                    ...
                    for (var i = 0, n = this._chartList.length; n > i; i++)
                        this._chartList[i].refresh &&
                            this._chartList[i].refresh(t)
                    this.component.grid &&
                        this.component.grid.refixAxisShape(this.component),
                        this._zr.refresh()
                },
                ...
                _mergeGlobalConifg: function (t) {
                    for (
                        ...
                        null == t[o] &&
                            (t[o] =
                                null != this._themeConfig[o]
                                    ? this._themeConfig[o]
                                    : a[o])
                    }
                    var r = t.color
                    ;(r && r.length) ||
                        (r = this._themeConfig.color || a.color),
                                  ...
                                  (this._option.dataZoom ||
                                      (this._option.toolbox &&
                                          ...
                                          this._option.toolbox.feature.dataZoom
                                              .show)) &&
                                  this.component.dataZoom.syncOption(
                                      this._option
                                  ),
                ...
                setSeries: function (e, t) {
                    return (
                        t
                            ? ((this._option.series = e),
                              this.setOption(this._option, t))
                ...
                addData: function (e, t, i, n, r) {
                    ...
                    return (
                        this.component.dataZoom &&
                            this.component.dataZoom.syncOption(h),
                        (this._option = h),
    ...
    define('zrender/tool/event', ['require', '../mixin/Eventful'], function (
        e
    ) {
        'use strict'
        function t (e) {
    ...
    define('zrender/tool/env', [], function () {
        function e (e) {
            var t = (this.os = {}),
                ...
                b =
                    e.match(/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/) &&
                    !U,
                f = e.match(/MSIE\s([\d.]+)/)
            return (
        ...
        return (
            ...
            (c.prototype.animate = function (e, t, a) {
                ...
                if (('string' == typeof e && (e = this.storage.get(e)), e)) {
                    ...
                    if (t) {
                        for (
                            var s = t.split('.'), l = e, h = 0, d = s.length;
                            d > h;
                            h++
                        )
                            l && (l = l[s[h]])
        ...
        return (
            (t.prototype = {
                ...
                add: function (e) {
                    ...
                    '#fff' === l.style.color &&
                        (l.style.color = e.style.strokeColor),
                ...
                del: function (e) {
                    ...
                    for (
                        var t = [], i = 0, n = this.shapeList.length;
                        n > i;
                        i++
                    )
                        this.shapeList[i].id != e.id &&
                            t.push(this.shapeList[i])
                    this.shapeList = t
                },
                ondrop: function (e, t) {
        ...
        return (
            (t.prototype = {
                    ...
                    if (i.length > 0) {
                        for (var r, n, a = 0, o = i.length; o > a; a++)
                            (r = i[a].name),
                                ...
                                (this._featureTitle[r] =
                                    t[n].title[r] || t[n].title),
                                t[n].icon &&
                                    (this._featureIcon[r] =
                                        t[n].icon[r] || t[n].icon),
                                t[n].color &&
                                    (this._featureColor[r] =
                                        t[n].color[r] || t[n].color),
                                t[n].option &&
                                    (this._featureOption[r] =
                                        t[n].option[r] || t[n].option)
                ...
                _buildItem: function () {
                    ...
                    'horizontal' === s.orient
                        ? ((i =
                              this._itemGroupLocation.y / this.zr.getHeight() <
                              0.5
                                  ? 'bottom'
                                  : 'top'),
                          (n =
                              this._itemGroupLocation.x / this.zr.getWidth() <
                              0.5
                                  ? 'left'
                                  : 'right'),
                          (o =
                        ...
                        switch (
                            ((t = {
                                ...
                                style: {
                                    ...
                                    lineWidth: 1,
                                    strokeColor:
                                        this._featureColor[this._iconList[U]] ||
                                        p[U % p.length],
                                    brushType: 'stroke'
                                },
                                highlightStyle: {
                            ...
                            default:
                                this._iconList[U].match('Chart')
                                    ? ((t._name = this._iconList[U].replace(
                                          'Chart',
                                          ''
                                      )),
                    ...
                    this.shapeList.push(
                        new o({
                            ...
                            style: {
                                ...
                                width:
                                    this._itemGroupLocation.width + t[3] + t[1],
                                height:
                                    this._itemGroupLocation.height +
                                    t[0] +
                                    t[2],
                                brushType:
                                    0 === e.borderWidth ? 'fill' : 'both',
                        ...
                        return (
                            (this._zoomShape = new o({
                                ...
                                highlightStyle: {
                                    lineWidth: 2,
                                    color:
                                        n.fillerColor || s.dataZoom.fillerColor,
                                    strokeColor:
                                        n.handleColor || s.dataZoom.handleColor,
                                    brushType: 'both'
                                }
                            })),
                            this.zr.addHoverShape(this._zoomShape),
                ...
                __onmouseup: function () {
                    ...
                    if (this._zooming && this.component.dataZoom) {
                        this._zooming = !1
                        var e = this.component.dataZoom.rectZoom(
                            this._zoomShape.style
                        )
                        e &&
                    ...
                    if (this._marking) this._marking = !1
                        ...
                        if (e >= 1) {
                            ...
                            this.zr.delShape(t.id),
                                ...
                                1 === e &&
                                    (this._iconDisable(
                                        this._iconShapeMap.markUndo
                                    ),
                                    this._iconDisable(
                                        this._iconShapeMap.markClear
                                    ))
                        }
                    }
                    return !0
                        ...
                        this._zoomStart &&
                            ...
                            this._iconShapeMap.dataZoom &&
                                this.zr.modShape(
                                    ...
                                    {
                                        style: {
                                            strokeColor: this._iconShapeMap
                                                .dataZoom.highlightStyle
                                                .strokeColor
                                        }
                                    }
                                ),
                ...
                getMagicOption: function () {
                    ...
                    if (
                        ...
                        for (
                            var i = this._magicType[s.CHART_TYPE_LINE]
                                    ? !1
                                    : !0,
                                n = 0,
                    ...
                    if (
                        ...
                        for (
                            var n = 0, a = this.option.series.length;
                            a > n;
                            n++
                        )
                            this._magicType[c]
                                ? ((this.option.series[n].stack =
                                  ...
                                  (t = c))
                                : this._magicType[m] &&
                                  ((this.option.series[n].stack = null),
                                  (t = m)),
                ...
                _defaultMagic: function (e, t) {
                    if (this._magicType[e] || this._magicType[t])
                        for (
                            var i = 0, n = this.option.series.length;
                            n > i;
                            i++
                        ) {
                            var a = this.option.series[i].type
                            ;(a == e || a == t) &&
                                ((this.option.series[i].type = this._magicType[
                                    e
                                ]
                                    ? e
                                    : t),
        ...
        return (
            (t.prototype = {
                ...
                _buildItem: function () {
                    var e = this.titleOption.text,
                        ...
                        u = {
                            ...
                            highlightStyle: {
                                color: l.lift(
                                    this.titleOption.textStyle.color,
                                    1
                                ),
                                brushType: 'fill'
                            },
                    ...
                    var V = {
                        ...
                        highlightStyle: {
                            color: l.lift(
                                this.titleOption.subtextStyle.color,
                                1
                            ),
                            brushType: 'fill'
                        },
                    ...
                    this.shapeList.push(
                        new a({
                            ...
                            style: {
                                ...
                                width:
                                    this._itemGroupLocation.width + e[3] + e[1],
                                height:
                                    this._itemGroupLocation.height +
                                    e[0] +
                                    e[2],
                ...
                refresh: function (e) {
                    e &&
                        ((this.option = e),
                        (this.option.title = this.reformOption(
                            this.option.title
                        )),
    ...
    define('echarts/component/tooltip', [
        ...
        function t (e, t, o, r, s) {
            ...
            ;(l._onmousemove = function (e) {
                ...
                this._axisShadowShape &&
                    this.zr.delShape(this._axisShadowShape.id),
                ...
                this._axisCrossShape &&
                    this.zr.delShape(this._axisCrossShape.id),
        ...
        return (
            (t.prototype = {
                ...
                _style: function (e) {
                    ...
                    e.backgroundColor &&
                        (t.push(
                            'background-Color:' + m.toHex(e.backgroundColor)
                        ),
                        ...
                        null != e.borderRadius &&
                            ...
                            t.push(
                                '-moz-border-radius:' + e.borderRadius + 'px'
                            ),
                            t.push(
                                '-webkit-border-radius:' + e.borderRadius + 'px'
                            ),
                    ...
                    n &&
                        ...
                        n.decoration &&
                            t.push('text-decoration:' + n.decoration),
                    ...
                    if (V) {
                        ...
                        for (var g = 0, f = l.length; f > g; g++)
                            this._isSelected(l[g].name) &&
                                ...
                                ((r =
                                    this.query(l[g], 'tooltip.showContent') ||
                                    r),
                                (a =
                                    this.query(l[g], 'tooltip.formatter') || a),
                ...
                _showPolarTrigger: function (e, t) {
                    ...
                    if (r.length > 0) {
                        ...
                        return (
                            this.hasAppend ||
                                ((this._tDom.style.left =
                                    this._zrWidth / 2 + 'px'),
                                (this._tDom.style.top =
                                    this._zrHeight / 2 + 'px'),
                                this.dom.firstChild.appendChild(this._tDom),
                                (this.hasAppend = !0)),
                            this._show(
                        ...
                        if ('island' != this._curTarget._type) {
                            ...
                            this.option.tooltip.trigger === g &&
                                ...
                                this.query(a, 'tooltip.trigger') === g &&
                                    ((n =
                                        this.query(a, 'tooltip.showContent') ||
                                        n),
                                    (t =
                                        this.query(a, 'tooltip.formatter') ||
                                        t),
                                    (i =
                                        this.query(a, 'tooltip.position') || i),
                                    (U += this._style(
                                        this.query(a, 'tooltip')
                                    ))),
                                    ...
                                    : ((this._curTicket = 0 / 0),
                                      (this._tDom.innerHTML =
                                          a.type === s.CHART_TYPE_RADAR && p
                                              ? this._itemFormatter.radar.call(
                                                    this,
                                                    a,
                                                    c,
                                                    m,
                        ...
                        if ('line' === c) {
                            ...
                            ;(this._axisCrossShape.style = {
                                ...
                                this.component.grid.getXend() - r > 100
                                    ? ((this._axisCrossShape.style.textAlign =
                                          'left'),
                                      (this._axisCrossShape.style.textX =
                                          r + 10))
                                    : ((this._axisCrossShape.style.textAlign =
                                          'right'),
                                      (this._axisCrossShape.style.textX =
                                ...
                                s - this.component.grid.getY() > 50
                                    ? ((this._axisCrossShape.style.textBaseline =
                                          'bottom'),
                                      (this._axisCrossShape.style.textY =
                                          s - 10))
                                    : ((this._axisCrossShape.style.textBaseline =
                                          'top'),
                                      (this._axisCrossShape.style.textY =
                            ...
                            'shadow' === c &&
                                ((null == m.shadow.width ||
                                    ...
                                    (m.shadow.width = o),
                                t === n
                                    ? Math.abs(this.component.grid.getX() - t) <
                                      2
                                        ? ((m.shadow.width /= 2),
                                          (t = n += m.shadow.width / 2))
                                        : Math.abs(
                                              this.component.grid.getXend() - t
                                          ) < 2 &&
                                          ((m.shadow.width /= 2),
                                          (t = n -= m.shadow.width / 2))
                                    : i === a &&
                                      (Math.abs(
                                          this.component.grid.getY() - i
                                      ) < 2
                                          ? ((m.shadow.width /= 2),
                    ...
                    if (
                        ...
                        if (t) {
                            ...
                            if (
                                ...
                                -1 !=
                                    (a = this.component.polar.isInside([i, n]))
                            )
                                for (
                            ...
                            (this._curTarget = !1),
                                ...
                                c.isInside(
                                    ...
                                    : this._needAxisTrigger &&
                                      this.component.polar &&
                                      -1 !=
                                          this.component.polar.isInside([i, n])
                                    ? (this._showingTicket = setTimeout(
                                          this._tryShow,
                                          this._showDelay
                                      ))
                ...
                _isSelected: function (e) {
                    return null != this._selectedMap[e]
                        ? this._selectedMap[e]
                        : !0
                },
                showTip: function (e) {
                    if (e) {
                        ...
                        if (null != e.seriesIndex) t = e.seriesIndex
                            ...
                            for (
                                var n = e.seriesName, a = 0, o = i.length;
                                o > a;
                                a++
                            )
                                if (i[a].name === n) {
                                    ...
                                    switch (d.type) {
                                        ...
                                        case s.CHART_TYPE_RADAR:
                                            ...
                                            var p = r.polarIndex || 0,
                                                u = this.component.polar.getVector(
                                                    p,
                                                    m,
                                                    'max'
                                                )
                ...
                refresh: function (e) {
                    if (
                        ...
                        for (
                            var t = this.option.series, i = 0, n = t.length;
                            n > i;
                            i++
                        )
                            if (
                                'axis' === this.query(t[i], 'tooltip.trigger')
                            ) {
                                this._needAxisTrigger = !0
                                break
                            }
                        ;(this._showDelay = this.option.tooltip.showDelay),
                            ...
                            (this._defaultCssText = this._style(
                                this.option.tooltip
                            )),
    ...
    define('echarts/component/legend', [
        ...
        t.prototype = {
                ...
                for (var x = 0; p > x; x++)
                    (o = h.merge(m[x].textStyle || {}, u)),
                        ...
                        '' !== e
                            ? ((t =
                                  m[x].icon ||
                                  this._getSomethingByName(e).type),
                              (c = this.getColor(e)),
                              'horizontal' === this.legendOption.orient
                                  ...
                                  : 200 > U - f &&
                                    ...
                                    ('right' === this.legendOption.x
                                        ? (g -=
                                              this._itemGroupLocation.maxWidth +
                                              _)
                                        : (g +=
                                              this._itemGroupLocation.maxWidth +
                                              _),
                              ...
                              (i = this._getItemShapeByType(
                                  ...
                                  y,
                                  b,
                                  this._selectedMap[e] && this._hasDataMap[e]
                                      ? c
                                      : '#ccc',
                                  t,
                                  c
                ...
                this.shapeList.push(
                    new a({
                        ...
                        style: {
                            ...
                            height:
                                this._itemGroupLocation.height + e[0] + e[2],
                            brushType:
                                0 === this.legendOption.borderWidth
                                    ? 'fill'
                                    : 'both',
                ...
                switch (this.legendOption.x) {
                    ...
                    case 'right':
                        f =
                            ...
                            c[1] -
                            c[3] -
                            2 * this.legendOption.borderWidth
                        break
                    default:
            ...
            _getSomethingByName: function (e) {
                for (
                    var t, i = this.option.series, n = 0, a = i.length;
                    a > n;
                    n++
                ) {
                    if (i[n].name === e)
            ...
            refresh: function (e) {
                if (e) {
                    ;(this.option = e || this.option),
                        (this.option.legend = this.reformOption(
                            this.option.legend
                        )),
            ...
            getColor: function (e) {
                return (
                    this._colorMap[e] ||
                        (this._colorMap[e] = this.zr.getColor(
                            this._colorIndex++
                        )),
                    this._colorMap[e]
                )
            ...
            add: function (e, t) {
                for (
                    var i = this.legendOption.data, n = 0, a = i.length;
                    a > n;
                    n++
                )
            ...
            del: function (e) {
                for (
                    var t = this.legendOption.data, i = 0, n = t.length;
                    n > i;
                    i++
                )
    ...
    define('zrender/tool/color', ['require', '../tool/util'], function (e) {
        ...
        function s (e, t, i, n, a, o, r) {
            O || (O = P.getContext())
            for (
                var s = O.createRadialGradient(e, t, i, n, a, o),
                    l = 0,
                    h = r.length;
                h > l;
                l++
                        ...
                        r.timelineOption.autoPlay &&
                            (r.playTicket = setTimeout(function () {
                                return (
                                    ...
                                    r.currentIndex >=
                                        r.timelineOption.data.length
                                        ? ((r.currentIndex =
                                              r.timelineOption.data.length - 1),
                                          void r.stop())
                                        : void r._onFrame()
                                )
            ...
            (t.prototype = {
                ...
                _getChainPoint: function () {
                    ...
                    for (var g, f, y, b, _, x = [], U = 0; p > U; U++)
                        (d = u[U]),
                            (g =
                                (h[U].symbol && h[U].symbol.toLowerCase()) ||
                                n),
                            g.match('empty')
                                ? ((g = g.replace('empty', '')), (y = !0))
                                : (y = !1),
                            g.match('star') &&
                                ((f = g.replace('star', '') - 0 || 5),
                                (g = 'star')),
                            (t = h[U].textStyle
                                ? l.merge(h[U].textStyle || {}, r)
                                : r),
                            (b = t.align || 'center'),
                            o
                                ? ((b = o > 0 ? 'right' : 'left'),
                ...
                _buildControl: function () {
                    ...
                    if ('none' !== t.controlPosition) {
                        ...
                        ;(this._ctrLastShape = new o(d)),
                            ...
                            (this._ctrPlayShape.style.status = this
                                .timelineOption.autoPlay
                                ? 'playing'
                                : 'stop'),
                ...
                _syncHandleShape: function () {
                    if (this.timelineOption.show) {
                        ...
                        ;(this._handleShape.style.text = t.label.show
                            ? i.name
                            : ''),
                ...
                __ondrift: function (e, t) {
                    ...
                    e.style.x + t <= n[0].x - n[0].symbolSize
                        ...
                        ? ((e.style.x = n[a - 1].x - n[a - 1].symbolSize),
                          (i = a - 1))
                        : ((e.style.x += t),
                    ...
                    if (
                        ...
                        (e.style.y =
                            this._location.y + this._location.height / 4 - r),
                        (e.style.width = 2 * r),
                        (e.style.height = 2 * r),
                        (e.style.text = o.name),
                        i === this.currentIndex)
                        ...
                        return !0
                    if (
                        ((this.currentIndex = i), this.timelineOption.realtime)
                    ) {
                        clearTimeout(this.playTicket)
                        var s = this
                ...
                last: function () {
                    return (
                        ...
                        this.currentIndex < 0 &&
                            (this.currentIndex =
                                this.timelineOption.data.length - 1),
                        this._onFrame(),
                        this.currentIndex
                    )
                },
                    ...
                    null != i.progress
                        ? (e(s),
                          (h.highlightStyle.width =
                              this.adjust(i.progress, [0, 1]) *
                              i.effectOption.width),
                          e(h),
                          e(r),
                          void t())
        ...
        return (
            ...
            (t.prototype._start = function (e, t) {
                for (
                    ...
                    var U =
                        'random' == l.color ? a.alpha(a.random(), 0.3) : l.color
                    m[V] = new o({
                        highlightStyle: {
                ...
                return setInterval(function () {
                    ...
                    for (var i = 0; h > i; i++) {
                        ...
                        n.y - m[i].animationY + n.r <= 0 &&
                            ...
                            (m[i].highlightStyle.x = Math.ceil(
                                Math.random() * p
                            ))),
            ...
            (t.prototype._start = function (e, t) {
                ...
                for (
                    var h = this.createTextShape(i.textStyle),
                        ...
                        f = [],
                        y = a.getGradientColors(
                            ['#ff6400', '#ffe100', '#97ff00'],
                            25
                        ),
                        b = 15,
                        _ = 240,
                ...
                if (null != i.progress) {
                    e(d),
                        (k =
                            (100 * this.adjust(i.progress, [0, 1]).toFixed(2)) /
                            5),
        ...
        return (
            ...
            (t.prototype._start = function (e, t) {
                ...
                var u = this.createBackgroundShape(i.backgroundColor),
                    ...
                    f = [0, m.x, m.y]
                return (
                    (V.highlightStyle.x = U.highlightStyle.x = g.highlightStyle.x =
                        f[1]),
                    (V.highlightStyle.y = U.highlightStyle.y = g.highlightStyle.y =
                        f[2]),
                    setInterval(function () {
                        e(u),
                            e(g),
    ...
    define('echarts/theme/macarons', [], function () {
        var e = {
            ...
            force: {
                itemStyle: { normal: { linkStyle: { color: '#1e90ff' } } }
            },
            chord: {
                itemStyle: {
                    normal: {
    ...
    define('echarts/theme/infographic', [], function () {
        var e = {
            ...
            force: {
                itemStyle: { normal: { linkStyle: { color: '#27727B' } } }
            },
            chord: {
                itemStyle: {
                    normal: {
        ...
        return (
            document.createElement('canvas').getContext
                ...
                : !(function () {
                      ...
                      function n (e, t, i) {
                          e.namespaces[t] ||
                              e.namespaces.add(t, i, '#default#VML')
                      }
                      function a (e) {
                          if (
                          ...
                          switch (e.propertyName) {
                              case 'width':
                                  t.getContext().clearRect(),
                                      (t.style.width =
                                          t.attributes.width.nodeValue + 'px'),
                              ...
                              case 'height':
                                  t.getContext().clearRect(),
                                      (t.style.height =
                                          t.attributes.height.nodeValue + 'px'),
                                      (t.firstChild.style.height =
                                          t.clientHeight + 'px')
                          }
                      }
                      function r (e) {
                      ...
                      ;(Q.clearRect = function () {
                          ...
                          (Q.quadraticCurveTo = function (e, t, i, n) {
                              var a = v(this, e, t),
                                  ...
                                  r = {
                                      x:
                                          this.currentX_ +
                                          (2 / 3) * (a.x - this.currentX_),
                                      y:
                                          this.currentY_ +
                                          (2 / 3) * (a.y - this.currentY_)
                                  },
                                  s = {
                          ...
                          (Q.createRadialGradient = function (
                              e,
                              t,
                              i,
                              n,
                          ...
                          (Q.measureText = function (e) {
                              ...
                              return (
                                  this.textMeasureEl_.appendChild(
                                      i.createTextNode(e)
                                  ),
        ...
        return (
            ...
            (e.prototype.dispatch = function (e) {
                if (this._handlers[e]) {
                    ...
                    for (
                        var n = this._handlers[e], a = n.length, o = 0;
                        a > o;
            ...
            (e.prototype.dispatchWithContext = function (e) {
                if (this._handlers[e]) {
                    var t = arguments,
                        i = t.length
                    i > 4 &&
                        (t = Array.prototype.slice.call(t, 1, t.length - 1))
                    for (
                        var n = t[t.length - 1],
                            a = this._handlers[e],
                            o = a.length,
        ...
        ;(U.prototype.on = function (e, t, i) {
            ...
            (U.prototype._processDragStart = function (e) {
                ...
                if (
                    ...
                    if (
                        t.dragEnableTime &&
                        new Date() - this._lastMouseDownMoment <
                            t.dragEnableTime
                    )
                        return
                    var i = t
                    ...
                    a &&
                        ...
                        ((e.zrenderX =
                            ('undefined' != typeof e.offsetX
                                ? e.offsetX
                                : e.layerX) + a.offsetLeft),
                        (e.zrenderY =
                            ('undefined' != typeof e.offsetY
                                ? e.offsetY
                                : e.layerY) + a.offsetTop))
                }
    ...
    define('zrender/Painter', [
        ...
        return (
            ...
            (h.prototype.getLayer = function (e) {
                ...
                return (
                    t ||
                        ...
                        (t.isBuildin = !0),
                        this._layerConfig[e] &&
                            o.merge(t, this._layerConfig[e], !0),
                        t.updateTransform(),
            ...
            (h.prototype.insertLayer = function (e, t) {
                ...
                if (i > 0 && e > this._zlevelList[0]) {
                    for (
                        ...
                        i - 1 > o &&
                        !(
                            this._zlevelList[o] < e &&
                            this._zlevelList[o + 1] > e
                        );
                        o++
                    );
            ...
            (h.prototype._shapeToImage = function (t, i, n, a, o) {
                ...
                return (
                    null != l.position &&
                        (d.position = i.position = l.position),
                    null != l.rotation &&
                        (d.rotation = i.rotation = l.rotation),
    ...
    define('zrender/Storage', ['require', './tool/util', './Group'], function (
        ...
        return (
            (o.prototype.iterShape = function (e, t) {
                if ((t || (t = a), t.hover))
                    for (
                        var i = 0, n = this._hoverElements.length;
                        n > i;
                        i++
                    ) {
            ...
            (o.prototype.getHoverShapes = function (e) {
                for (
                    var i = [], n = 0, a = this._hoverElements.length;
                    a > n;
                    n++
                ) {
            ...
            (o.prototype.drift = function (e, t, i) {
                ...
                return (
                    n &&
                        ...
                        (!n.ondrift || (n.ondrift && !n.ondrift(t, i))) &&
                            n.drift(t, i)),
                    this
                )
            }),
            (o.prototype.addHover = function (e) {
                return (
                    e.updateNeedTransform(), this._hoverElements.push(e), this
                )
            }),
        ...
        var n = e('./mixin/Transformable'),
            ...
            s = function (e, a) {
                ;(this.id = e),
                    ...
                    (this.dom.style['-webkit-tap-highlight-color'] =
                        'rgba(0,0,0,0)'),
            ...
            (i.prototype = {
                ...
                _buildRadiusPath: function (e, t) {
                    ...
                    i + n > l && ((c = i + n), (i *= l / c), (n *= l / c)),
                        ...
                        e.lineTo(r + l, s + h - a),
                        0 !== a &&
                            e.quadraticCurveTo(r + l, s + h, r + l - a, s + h),
                        e.lineTo(r + o, s + h),
    ...
    define('zrender/tool/area', ['require', './util', './curve'], function (e) {
        ...
        function y (e, t, i, n, a, o, r, s) {
            ...
            if (h >= 0 && 1 >= h) {
                for (
                    var d = 0, c = w.quadraticAt(t, n, o, h), m = 0;
                    l > m;
                    m++
                ) {
            ...
            for (
                ...
                switch (k.command) {
                    ...
                    case 'C':
                        if (
                            g &&
                            s(d, c, v[0], v[1], v[2], v[3], v[4], v[5], t, n, a)
                        )
                            return !0
                        _ &&
                            (o += f(
        ...
        return (
            ...
            (d.prototype.getHighlightStyle = function (t, i, n) {
                ...
                'stroke' != t.brushType
                    ? ((a.strokeColor = s),
                      (a.lineWidth =
                          (t.lineWidth || 1) + this.getHighlightZoom()),
                      (a.brushType = 'both'))
                    : 'stroke' != n
                    ? ((a.strokeColor = s),
                      (a.lineWidth =
            ...
            (l.prototype = {
                ...
                lookAt: (function () {
                    ...
                    return function (i) {
                        ...
                        if (
                            (a.sub(e, i, this.position), !t(e[0]) || !t(e[1]))
                        ) {
                            a.normalize(e, e)
                            var r = this.scale
                            ;(o[2] = e[0] * r[1]),
            ...
            (o.prototype.addChild = function (e) {
                e != this &&
                    ...
                    this._storage &&
                        ...
                        e instanceof o &&
                            e.addChildrenToStorage(this._storage)))
            }),
            (o.prototype.removeChild = function (e) {
                ...
                t >= 0 && this._children.splice(t, 1),
                    ...
                    this._storage &&
                        ...
                        e instanceof o &&
                            e.delChildrenFromStorage(this._storage))
            }),
            (o.prototype.clearChildren = function () {
                for (var e = 0; e < this._children.length; e++) {
                    ...
                    this._storage &&
                        ...
                        t instanceof o &&
                            t.delChildrenFromStorage(this._storage))
                }
            ...
            (i.prototype = {
                        ...
                        if (-1 === r) {
                            ...
                            ;(i = {
                                ...
                                this.type === h.CHART_TYPE_PIE &&
                                    ...
                                    (i.value = 0)
                            for (
                                var c = !1, m = s[o].data, u = 0, V = m.length;
                                V > u;
                                u++
                            )
                                m[u].name === i.name &&
                                ...
                                null != i.value
                                    ? ((s[o].data[r].value =
                                      ...
                                      (this.type === h.CHART_TYPE_FUNNEL ||
                                          ...
                                          (l &&
                                              1 ===
                                                  l.getRelatedAmount(i.name) &&
                                              this.component.legend.del(i.name),
                                          (i.name +=
                                              this.option.nameConnector +
                                              d.get(a, 'name')),
                                          l &&
                                              l.add(
                                                  i.name,
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (this.type == h.CHART_TYPE_LINE)
                                    ...
                                    t.itemStyle.normal.barBorderWidth > 0
                                ) {
                            ...
                            (this.selectedMap[n] = !0),
                                (this._sIndex2ColorMap[e[p]] = this.zr.getColor(
                                    e[p]
                                ))
                        this.selectedMap[n] &&
                            ((i = t.stack || l + e[p]),
                    ...
                    for (
                        ...
                        (t = o.data[r]),
                            ...
                            !t.type ||
                                ...
                                (t.symbolSize =
                                    t.symbolSize ||
                                    g.getTextWidth(i[3], this.getFont()) / 2 +
                                        5))
                    for (
                ...
                _buildMarkLine: function (e) {
                    for (
                        ...
                        ('max' !== s.type &&
                            ...
                            'average' !== s.type)
                            ? (t = [
                                  this.getMarkCoord(e, s[0]),
                                  this.getMarkCoord(e, s[1])
                              ])
                            ...
                            null != t &&
                                ...
                                null != t[1] &&
                                ((a.data[o][0].x =
                                    null != s[0].x ? s[0].x : t[0][0]),
                                (a.data[o][0].y =
                                    null != s[0].y ? s[0].y : t[0][1]),
                                (a.data[o][1].x =
                                    null != s[1].x ? s[1].x : t[1][0]),
                                (a.data[o][1].y =
                                    null != s[1].y ? s[1].y : t[1][1]))
                    }
                ...
                _markLine: (function () {
                    ...
                    return function (i, n) {
                        ...
                        if (L) {
                            var w = new V()
                            ;(w.maxTurningAngle =
                                (this.query(n, 'bundling.maxTurningAngle') /
                                    180) *
                                Math.PI),
                                (m = w.run(m))
                        }
                        ...
                        for (var W = [], g = 0, X = m.length; X > g; g++) {
                            ...
                            C.show &&
                                ((K.effect = C), (K.effect.large = n.large)),
                ...
                getMarkLineShape: function (e, t, i, n, a, r, l) {
                    var h = null != i[0].value ? i[0].value : '-',
                        ...
                        c = [
                            i[0].symbol || e.symbol[0],
                            i[1].symbol || e.symbol[1]
                        ],
                        m = [
                    ...
                    var p = [
                            this.query(i[0], 'symbolRotate') ||
                                e.symbolRotate[0],
                            this.query(i[1], 'symbolRotate') ||
                                e.symbolRotate[1]
                        ],
                        u = [i[0], i[1], e],
                    ...
                    var b = f.width
                    null == b &&
                        (b = null != U.borderWidth ? U.borderWidth : y + 2)
                    ...
                    var x = r ? s : o,
                        k = new x({
                            style: {
                                ...
                                color: V.color || l,
                                strokeColor:
                                    g.color || V.borderColor || V.color || l,
                                lineWidth: y,
                                symbolBorderColor:
                                    V.borderColor || V.color || l,
                ...
                getLargeMarkPointShape: function (e, t) {
                    ...
                    if (
                        ...
                        !m ||
                            ...
                            (o =
                                this.deepQuery(u, 'itemStyle.normal.color') ||
                                n),
                            (s =
                                this.deepQuery(u, 'itemStyle.emphasis.color') ||
                                o),
                            null != o || null != s))
                    ) {
                ...
                animationMark: function (e, t, i) {
                    for (
                        var i = i || this.shapeList, n = 0, a = i.length;
                        a > n;
                        n++
                    )
                ...
                clearEffectShape: function (e) {
                    ...
                    if (this.zr && t && t.length > 0) {
                        e &&
                            this.zr.modLayer(h.EFFECT_ZLEVEL, {
                                motionBlur: !1
                            }),
                            this.zr.delShape(t)
                ...
                addMark: function (e, t, i) {
                    ...
                    if (this.selectedMap[n.name]) {
                        ...
                        if (
                            ...
                            for (
                                var l = s, h = this.shapeList.length;
                                h > l;
                                l++
                            )
                ...
                delMark: function (e, t, i) {
                    ...
                    if (this.selectedMap[n.name]) {
                        for (
                            var a = !1,
                                o = [this.shapeList, this.effectList],
                                r = 2;
                            r--;
                ...
                getRect: function (e) {
                    return e.__rect
                        ...
                        : ((e.__rect = {
                              ...
                              width: e.width,
                              height:
                                  e.height * ('pin' === e.iconType ? 1.25 : 1)
                          }),
                          e.__rect)
                },
    ...
    define('echarts/util/shape/MarkLine', [
        ...
        return (
            (t.prototype = {
                ...
                brushSymbol: function (e, t, i) {
                    if ('none' != t.symbol[i]) {
                        ...
                        var o = t.xStart,
                            ...
                            m = t.curveness || 0,
                            p =
                                null != t.symbolRotate[i]
                                    ? t.symbolRotate[i] - 0
                                    : 0
                        if (
                            ((p = (p / 180) * Math.PI), 'arrow' == a && 0 === p)
                        )
                            if (0 === m) {
                                var u = 0 === i ? -1 : 1
                                p =
                                    Math.PI / 2 +
                                    Math.atan2(u * (l - r), u * (s - o))
                            } else {
                                var V = t.cpX1,
                                    U = t.cpY1,
                ...
                getRect: function (e) {
                    return (
                        e.curveness > 0 ? s.getRect(e) : o.getRect(e), e.__rect
                    )
                },
                isCover: function (e, t) {
                    var i = this.transformCoordToLocal(e, t)
        ...
        function n (e, t, i, n, a) {
            ...
            if (i instanceof m) {
                for (
                    ...
                    if (k) {
                        var L = k[2 * (v - 1)],
                            w = k[2 * (v - 1) + 1]
                        _ +=
                            p.dist(x[v - 1], L) + p.dist(L, w) + p.dist(w, x[v])
                ...
                var T = (K - I) * (K - I) + (C - S) * (C - S),
                    E = Math.round(
                        Math.sqrt(Math.round(T * s.period * s.period))
                    )
        ...
        function t (e, t, a, o, r) {
            ...
            ;(s._onlegendhoverlink = function (e) {
                if (s.legendHoverLink)
                    for (
                        var t, a = e.target, o = s.shapeList.length - 1;
                        o >= 0;
                        o--
                    )
                        (t =
                            s.type == i.CHART_TYPE_PIE ||
                            s.type == i.CHART_TYPE_FUNNEL
        ...
        return (
            (t.prototype = {
                ...
                reformOption: function (e) {
                    return (
                        (e = r.merge(
                            r.merge(
                                e || {},
                                r.clone(this.ecTheme[this.type] || {})
                            ),
                            r.clone(i[this.type] || {})
                        )),
                        (this.z = e.z),
                ...
                subPixelOptimize: function (e, t) {
                    return (e =
                        t % 2 === 1 ? Math.floor(e) + 0.5 : Math.round(e))
                },
                resize: function () {
                    ...
                    var d = [],
                        c = function (e, t) {
                            for (var a, o = 0; o < e.length; o++) {
                                ...
                                if (
                                    r.edgeList[0] &&
                                    r.edgeList[0].edge instanceof i
                                ) {
                                    for (
                                        var s = [], l = 0;
                                        l < r.edgeList.length;
            ...
            (i.prototype = {
                ...
                buildPath: function (e, t) {
                    e.moveTo(t.xStart, t.yStart),
                        'undefined' != typeof t.cpX2 &&
                        'undefined' != typeof t.cpY2
                            ? e.bezierCurveTo(
                                  t.cpX1,
                                  t.cpY1,
                                  t.cpX2,
        ...
        return (
            (t.prototype = {
                ...
                brushSymbol: function (e, t) {
                    ...
                    e.save()
                    for (
                        var a, o = t.chainPoint, r = 0, s = o.length;
                        s > r;
                        r++
                    ) {
                ...
                axisBase: {
                    _buildAxisLine: function () {
                        ...
                        '' !== this.option.name &&
                            ...
                            (o.textFont = this.getFont(
                                this.option.nameTextStyle
                            )),
                            ...
                            (o.lineWidth = e),
                            this.isHorizontal()
                                ? (o.yStart = o.yEnd = this.subPixelOptimize(
                                      o.yEnd,
                                      e
                                  ))
                                : (o.xStart = o.xEnd = this.subPixelOptimize(
                                      o.xEnd,
                                      e
                                  )),
                    ...
                    refixAxisShape: function (e, t) {
                        if (this.option.axisLine.onZero) {
                            ...
                            if (this.isHorizontal() && null != t)
                                for (
                                    var n = 0, a = this.shapeList.length;
                                    a > n;
                                    n++
                                )
            ...
            (t.prototype = {
                ...
                refresh: function (e) {
                    if (
                        ...
                        this.clear(),
                            (this.option = e || this.option),
                            (this.option.grid = this.reformOption(
                                this.option.grid
                            ))
                        ...
                        ;(this._width =
                            ...
                            (this._height =
                                this._height <= 0 ? 10 : this._height),
                            (this._x = this.subPixelOptimize(
                                this._x,
                                t.borderWidth
                            )),
                            (this._y = this.subPixelOptimize(
                                this._y,
                                t.borderWidth
                            )),
                            this.shapeList.push(
        ...
        return (
            (t.prototype = {
                ...
                _getZoom: function () {
                    ...
                    !t ||
                        t instanceof Array ||
                        ((t = [t]), (this.option.xAxis = t))
                    var i = this.option.yAxis
                    !i ||
                        i instanceof Array ||
                        ((i = [i]), (this.option.yAxis = i))
                    var n,
                        a,
                        o = [],
                    ...
                    if (t && null == s) {
                        ...
                        for (var l = 0, h = t.length; h > l; l++)
                            ('category' == t[l].type || null == t[l].type) &&
                                n.push(l)
                    ...
                    for (var d, l = 0, h = e.length; h > l; l++)
                        if (
                            ...
                            null == this.zoomOption.xAxisIndex &&
                                ...
                                d.data &&
                                this.getDataFromOption(d.data[0]) instanceof
                                    Array &&
                                (d.type == r.CHART_TYPE_SCATTER ||
                                    d.type == r.CHART_TYPE_LINE ||
                                    d.type == r.CHART_TYPE_BAR) &&
                ...
                _backupData: function () {
                    ...
                    for (
                        ...
                        (s = l[h[i]]),
                            ...
                            s.data &&
                                this.getDataFromOption(s.data[0]) instanceof
                                    Array &&
                ...
                _buildBackground: function () {
                    ...
                    for (
                        ...
                        (m = this.getDataFromOption(u[l], 0)),
                            this.option.series[p].type == r.CHART_TYPE_K &&
                                (m = m[1]),
                            isNaN(m) && (m = 0),
                            (V = Math.max(V, m)),
                            (U = Math.min(U, m))
                ...
                _buildFrame: function () {
                    ...
                    ;(this._startFrameShape = {
                        ...
                        style: {
                            ...
                            width:
                                this._location.width -
                                (e > this._location.x ? 1 : 0),
                            height:
                                this._location.height -
                                (t > this._location.y ? 1 : 0),
                            lineWidth: 1,
                            brushType: 'stroke',
                        ...
                        for (var l in t)
                            (o = t[l]),
                                null != o &&
                                    ((a = o.length),
                                    (i = Math.floor(
                                        (this._zoom.start / 100) * a
                                    )),
                                    (n = Math.ceil((this._zoom.end / 100) * a)),
                                    this.getDataFromOption(o[0]) instanceof
                                        Array &&
                                    this.option[s][l].type != r.CHART_TYPE_K
                                        ? (this._setScale(),
                                          (this.option[s][
                                              l
                                          ].data = this._synScatterData(l, o)))
                                        : (this.option[s][l].data = o.slice(
                                              i,
                                              n
                                          )))
                    }
                ...
                _getDetail: function () {
                    for (
                        var e = ['xAxis', 'yAxis'], t = 0, i = e.length;
                        i > t;
                        t++
                    ) {
                ...
                rectZoom: function (e) {
                    ...
                    if (
                        (i.width < 0 &&
                            ((i.x += i.width), (i.width = -i.width)),
                        i.height < 0 &&
                            ((i.y += i.height), (i.height = -i.height)),
                ...
                syncBackupData: function (e) {
                    for (
                        ...
                        ;(i = a[o].data || a[o].eventList),
                            (t = n[o]
                                ? Math.floor(
                                      (this._zoom.start / 100) * n[o].length
                                  )
                                : 0)
        ...
        return (
            (t.prototype = {
                    ...
                    var e,
                        ...
                        l =
                            'function' == typeof n.interval
                                ...
                                : 'auto' == n.interval &&
                                  'function' ==
                                      typeof this.option.axisLabel.interval
                    ...
                    if (this.isHorizontal()) {
                        ...
                        for (var u = 0; a > u; u += this._interval)
                            (c && !c(u, i[u])) ||
                                ...
                                this.shapeList.push(
                                    new n(this._axisLabelClickable(h, e))
                                ))
                    } else {
                        var V, U
                        'left' == this.option.position
                ...
                getGap: function () {
                    var e = this.option.data.length,
                        t = this.isHorizontal()
                            ? this.grid.getWidth()
                            : this.grid.getHeight()
                    return this.option.boundaryGap
                        ? t / e
                        : t / (e > 1 ? e - 1 : 1)
                },
                getCoord: function (e) {
                ...
                getIndexByName: function (e) {
                    for (
                        var t = this.option.data, i = t.length, n = 0;
                        i > n;
                        n++
                    )
        ...
        return (
            (t.prototype = {
                    ...
                    if (this.isHorizontal()) {
                        ...
                        for (var d = 0; i > d; d++)
                            (e = {
                                ...
                                this.shapeList.push(
                                    new n(this._axisLabelClickable(r, e))
                                )
                    } else {
                        var c, m
                        'left' === this.option.position
                ...
                _calculateValue: function () {
                    if (
                        isNaN(this.option.min - 0) ||
                        isNaN(this.option.max - 0)
                    ) {
                        for (
                            var e,
                                t,
                            ...
                            !(
                                (this.series[a].type != r.CHART_TYPE_LINE &&
                                    ...
                                    this.series[a].type !=
                                        r.CHART_TYPE_SCATTER &&
                                    this.series[a].type != r.CHART_TYPE_K &&
                                    this.series[a].type !=
                                        r.CHART_TYPE_EVENTRIVER) ||
                        ...
                        ;(this._min = isNaN(this.option.min - 0)
                            ...
                            this._min === this._max &&
                                (0 === this._max
                                    ...
                                    : this._max > 0
                                    ? (this._min =
                                          this._max / this.option.splitNumber !=
                                          null
                ...
                _calculSum: function (e, t) {
                    ...
                    if (this.series[t].stack) {
                        ...
                        for (var h = 0, d = n.length; d > h; h++)
                            for (
                                var c = n[h].evolution, m = 0, p = c.length;
                                p > m;
                                m++
                            )
                ...
                _customerValue: function () {
                    ...
                    this._valueList = []
                    for (var a = 0; i >= a; a++)
                        this._valueList.push(
                            t.accAdd(this._min, t.accMul(n, a))
                        )
                    this._reformLabelData()
                },
                ...
                getValueFromCoord: function (e) {
                    ...
                    return (
                        this.isHorizontal()
                            ? ((e =
                                  e < this.grid.getX() ? this.grid.getX() : e),
                              (e =
                                  e > this.grid.getXend()
                                      ? this.grid.getXend()
                                      : e),
                              (t =
                                  ...
                                  ((e - this.grid.getX()) /
                                      ...
                                      (this._max - this._min)))
                            : ((e =
                                  e < this.grid.getY() ? this.grid.getY() : e),
                              (e =
                                  e > this.grid.getYend()
                                      ? this.grid.getYend()
                                      : e),
